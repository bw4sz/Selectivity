...
Optimal theory posits that species should feed three times as much on the high value then the low value. However, we see that overall, species feed `r print(sH/sL)` times more on the low value resource. 
