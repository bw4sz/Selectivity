...
response<-cbind((minutes(mod_data$Time_High)*60+seconds(mod_data$Time_High)),(minutes(mod_data$Time_Low)*60+seconds(mod_data$Time_Low)))
...
m_MorphResources<-glm(data=mod_data,response~fl_s:Species + Mass:Species,family="binomial",weights=mod_data$Minutes_Total,na.action="na.fail")

m_MorphXResources<-glm(data=mod_data,response~fl_s:Species * Mass:Species,family="binomial",na.action="na.fail")

m_PhyloXResources<-glm(data=mod_data,response~fl_s:Species * PhyloD:Species,family="binomial",na.action="na.fail")
